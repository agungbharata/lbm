      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="p-6 rounded-xl border border-gray-100 hover:border-[#00ACEE] transition-colors duration-300 hover:shadow-lg"
            >
              <div className="w-12 h-12 bg-[#00ACEE]/10 rounded-lg flex items-center justify-center mb-4">
                {feature.icon}
              </div>
